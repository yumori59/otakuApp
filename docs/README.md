...
無料版は**名義3件まで**＋広告、Plus（月¥350 / 年¥2,800）で名義無制限・広告なし・同期・共有・統計。
...
次に**他人（家族・友人）の氏名とFC会員番号を預かる**という個人情報リスク。会員番号は任意項目かつ暗号化保存、
既定で下4桁のみ表示、共有時はマスキング既定。詳細は [08-compliance-risk.md](./08-compliance-risk.md)。
